  ...
  (app) => {
    const planosVivaConfig = new Collection({
      ...
      fields: [
        ...
        { name: 'valor_plano', type: 'number', required: false },
        { name: 'prolabore_medico_percentual', type: 'number', required: false },
    ...
    const custosEquipeConfig = new Collection({
      ...
      fields: [
        ...
        { name: 'valor_sessao', type: 'number', required: false },
        { name: 'quantidade_sessoes', type: 'number', required: false, onlyInt: true },
        { name: 'created', type: 'autodate', onCreate: true, onUpdate: false },
        { name: 'updated', type: 'autodate', onCreate: true, onUpdate: true },
      ],
    })
